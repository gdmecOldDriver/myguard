package edu.gdmec.s07150815.myguard.m9advancedtools.db.dao;
...
import edu.gdmec.s07150815.myguard.m9advancedtools.db.AppLockOpenHelper;
...
public class AppLockDao {
    ...
    private Uri uri = Uri.parse("content://cn.edu.gdmec.s07150815.myguard.applock");
    ...
    public boolean find(String packagename){
        ...
        Cursor cursor = db.query("applock",null,"packagename=?",new String[]{packagename},null,
                null,null);
