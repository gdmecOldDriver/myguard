package edu.gdmec.s07150815.myguard.m6cleancache;
...
import edu.gdmec.s07150815.myguard.m6cleancache.adapter.CacheCleanAdapter;
...
public class CacheClearListActivity extends AppCompatActivity implements View.OnClickListener{
          ...
          switch (msg.what){
              ...
              case FINISH:
                  ...
                  if (cacheMemory>0){
                      ...
                      Toast.makeText(CacheClearListActivity.this,"你的手机洁净如新",Toast.LENGTH_SHORT).show();
                  }
                  break;
          }
      };
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_clean_cache_list);
    ...
    //获取某个包名对应的应用程序的缓存大小    info应用程序的包信息
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case  R.id.btn_cleanall:
                if (cacheMemory>0){
                    //跳转至清理缓存的页面的Activity
                    Intent intent=new Intent(this,CacheCleanAdapter.class);
                    //将要清理的垃圾大小传递至另一个页面
