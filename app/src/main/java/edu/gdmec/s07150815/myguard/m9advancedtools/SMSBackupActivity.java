...
import edu.gdmec.s07150815.myguard.m9advancedtools.utils.SmsBackUpUtils;
        ...
        switch (v.getId()) {
            ...
            case R.id.mcp_smsbackup:
                ...
                new Thread() {
                    public void run() {
                        try {
                            boolean backUpSms = smsBackUpUtils.backupSms(SMSBackupActivity.this, new
                                    SmsBackUpUtils.BackupStatusCallBack() {
