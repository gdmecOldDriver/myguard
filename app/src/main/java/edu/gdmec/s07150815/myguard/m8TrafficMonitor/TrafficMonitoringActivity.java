...
public class TrafficMonitoringActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!SystemInfoUtils.isServiceRunning(this,"edu.gdmec.s07150815.myguard.m8trafficMonitor.service.TrafficMonitoringService")){
    ...
    private void initData(){
        ...
        mTotalTV.setText("本日已用："+ Formatter.formatFileSize(this,mobileGPRS));
    }
        ...
        switch (v.getId()){
            ...
            case R.id.btn_correction_flow:
                ...
                switch (i) {
                    case 0:
                        //没有设置运营商
                      Toast.makeText(this,"您还没有设置运营信息",Toast.LENGTH_SHORT).show();
                        break;
